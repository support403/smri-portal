        ...
        <div style={{ padding: "0 12px", height: 52, display: "flex", alignItems: "center", justifyContent: "space-between", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, flex: 1 }}>
            ...
            <div style={{ borderLeft: "1px solid " + C.border, paddingLeft: 8, minWidth: 0 }}>
              <p style={{ fontSize: window.innerWidth < 768 ? 9 : 12, color: C.muted, margin: 0, lineHeight: 1, whiteSpace: "nowrap" }}>実務従事プログラム</p>
              <p style={{ fontSize: window.innerWidth < 768 ? 11 : 15, fontWeight: 700, color: C.navy, margin: "2px 0 0", lineHeight: 1, whiteSpace: "nowrap" }}>経営支援実務研修</p>
            </div>
          </div>
